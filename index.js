...
app.post('/editEvent/:EventID', (req, res) => {
  ...
  const NumVolunteers = parseInt(req.body.NumVolunteers) || '';

  const VestsProduced = parseInt(req.body.VestsProduced) || '';

  const EnvelopesProduced = parseInt(req.body.EnvelopesProduced) || '';

  const PocketsProduced = parseInt(req.body.PocketsProduced) || '';

  const CollarsProduced = parseInt(req.body.CollarsProduced) || '';

  const FullyCompletedProducts = parseInt(req.body.FullyCompletedProducts) || '';
  ...
  knex('Event')
      ...
      .update({
          ...
          VestsProduced: VestsProduced,

          EnvelopesProduced: EnvelopesProduced,

          PocketsProduced: PocketsProduced,

          CollarsProduced: CollarsProduced,

          FullyCompletedProducts: FullyCompletedProducts
